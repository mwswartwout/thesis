...
roslaunch cwru_turtlebot one_stationary.launch sim_time:=10800

roslaunch cwru_turtlebot one_mobile.launch sim_time:=10800 debug:=true

roslaunch cwru_turtlebot two_stationary.launch sim_time:=10800

roslaunch cwru_turtlebot two_mobile.launch sim_time:=10800 debug:=true
